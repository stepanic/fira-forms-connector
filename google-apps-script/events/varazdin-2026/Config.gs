/**
 * Event Configuration: Susret Varaždin 2026
 * Organizator: Katolička udruga "Prilika za Susret" Osijek,
 *   uz podršku Obiteljskog centra — ureda za obitelj Varaždinske biskupije
 * Lokacija: Pastoralni centar, Varaždin
 * Datum: 14. studenoga 2026. (subota), 9:30 – 19:00
 *
 * Prijave: do 6.11.2026. (ograničen broj mjesta)
 *
 * Cijene (per row — iznos ide u stupac UPLATA):
 *   Rana kotizacija (do 15.10.2026.):        50 €  (povrat moguć do 2.11. i uz zamjensku prijavu)
 *   Redovna kotizacija (nakon 15.10.2026.):  55 €
 *   Na dan susreta, gotovinski (14.11.):     60 €  → stupac "Payment Type" postavi na GOTOVINA
 * Rok uplate na račun Udruge: 6.11.2026.
 * Opis uplate: KOTIZACIJA ZA SUSRET VARAŽDIN (model HR99, poziv na broj prazan)
 *
...
var CONFIG = {
  // ── Event-specific ──────────────────────────────────────────────────────
  SERVICE_NAME: 'Kotizacija za Susret Varaždin — Prilika Za Susret',
  DELIVERY_PLACE: 'Varaždin',
  CONFERENCE_DATE: '2026-11-14',   // ISO format YYYY-MM-DD (subota)
  ...
  // EXACT headeri iz response sheeta "Susret Varaždin (Odgovori)"
  ...
  //
  // Stupci Uplate, OIB, Payment Type, Tip dokumenta i AKCIJA_FIRA_RACUN ne
  // dolaze iz forme — "FIRA Actions → 📋 Dodaj stupce za fiskalizaciju"
  // dodaje one koji fale. "Uplate" je organizator već dodao ručno (stupac H).
  COLUMNS: {
    EMAIL: 'E-adresa',
    PAYMENT: 'Uplate',                             // ⚠️ množina — organizator ga je ručno dodao pod tim imenom
    NAME: 'Ime i prezime',
    GENDER: 'Spol',
